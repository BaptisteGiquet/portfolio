...
private:
    ...
    TSharedPtr<FJsonObject> HandleGetActorFullInfo(const TSharedPtr<FJsonObject>& Params);
    ...
    TSharedPtr<FJsonObject> HandleFixInvalidNaniteMaterials(const TSharedPtr<FJsonObject>& Params);
    ...
    TSharedPtr<FJsonObject> HandleCaptureEditorScreenshot(const TSharedPtr<FJsonObject>& Params);

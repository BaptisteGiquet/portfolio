...
public:
    ...
    // Property utilities
    static bool HasObjectProperty(UObject* Object, const FString& PropertyName);
    static UActorComponent* FindActorComponent(AActor* Actor, const FString& ComponentQuery, FString& OutErrorMessage);
